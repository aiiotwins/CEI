            ...
            <div class="span4">
                <div class="widget widget-simple">
                    <div class="widget-header">
                        ...
                        <button type="button" style="display:none;" id="btnTambahMasterAcara" class="btn btn-green pull-right"><i class="fontello-icon-list-add"></i>Tambah</button>
                    </div>
                    <!-- // widget header -->
            ...
            <div class="span8">
                <div class="widget widget-simple">
                    <div class="widget-header">
                        ...
                        <a class="btn btn-success pull-right" style="display:none;" id="btnTambahKegiatan"><i class="fontello-icon-list-add"></i> Tambah</a>
                    </div>
                    <!-- // widget header -->
                    <div class="widget-content">
                        <div class="widget-body">
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        setTimeout(function(){
            if($("#roleUser").val() == 1){            
                $("#btnTambahMasterAcara").removeAttr('style');
                $("#btnTambahKegiatan").removeAttr('style');
            } 
        }, 100);  
